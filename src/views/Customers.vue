    ...
    <v-card class="ma-4">
      ...
      >
        ...
        <template #item.level="{ value }">
          <v-icon v-if="value == 'Diamond'" color="light-blue-lighten-2">mdi-diamond-stone</v-icon>
          <v-icon v-if="value == 'Gold'" color="amber-lighten-1">mdi-crown</v-icon>
          <v-icon v-if="value == 'Silver'" color="grey-lighten-1">mdi-crown</v-icon>
        </template>
      </v-data-table-server>
    </v-card>
  </admin-navbar>
...
const headers = [
  ...
  { title: "No. of orders", key: "customer_orders_count", align: "center", sortable: true },
];
