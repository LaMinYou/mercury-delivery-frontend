    ...
    <v-container class="fill-height bg-grey-lighten-4" fluid>
      <v-row justify="center" align="center">
        <v-col cols="12" sm="8" md="5" lg="4">
          ...
          <!-- bg-white အစား color="white" သို့ပြောင်းပါ -->
          <v-card color="white" class="pa-6 rounded-xl elevation-3">
            ...
            <div class="d-flex align-center my-6">
              <v-divider></v-divider>
              <span class="mx-4 text-caption text-grey font-weight-medium">OR</span>
              <v-divider></v-divider>
            </div>
