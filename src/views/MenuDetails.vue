        ...
        <v-form @submit.prevent="handleSubmit">
          <v-row>
            <v-col cols="12" md="6">
              <v-text-field
                v-model="menu.title"
                :rules="[rules.required('item title')]"
                label="Item title (eg. ဒံပေါက်, lotion)"
            ...
            <v-col cols="12" md="6">
              <v-text-field
                ...
                :rules="[rules.required('item subtitle')]"
                label="Item subtitle (eg. ဆိတ်သားဒံပေါက်, vaseline lotion)"
                prepend-inner-icon="mdi-food-outline"
                variant="solo"
                bg-color="#fff"
              ></v-text-field>
            ...
            <v-col cols="12">
              <v-textarea
                ...
                placeholder="Describe your item description here..."
